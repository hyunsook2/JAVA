...
public class StreamMakeRun {
	...
	Stream<String> streamFile = Files.lines(Paths.get("C:\\Users\\kosmo\\javastudy\\src\\study20\\testfile.txt"),
		Charset.forName("UTF-8"));
	streamFile.forEach(str->System.out.println(str+" "));
	System.out.println();
	//null->빈 스트림
	ArrayList<String> alist2 = new ArrayList<>();
	if(alist2==null||alist2.isEmpty()) {
		Stream.empty(); // 빈 스트림
	}else {
		alist2.stream();
	}
	...
	istream.forEach(str->System.out.print(str+" "));
	System.out.println();
