...
public class StreamIntermediateOperatorRun {
	public static void main(String[] args) {
		...
		System.out.println();
		// peek()
		lang.stream().peek(System.out::println).sorted(Comparator.reverseOrder()).peek(System.out::println).sorted()
				.forEach(e -> System.out.print(e + " "));
		System.out.println();
		int sum = IntStream.of(1,42,12,51,67).skip(1).limit(3).peek(System.out::println).sum();
