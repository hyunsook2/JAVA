...
public class TreeMapRun {
	public static void main(String[] args) {
		...
		System.out.println(tmap.floorKey(17));//이하
		System.out.println(tmap.floorEntry(18));//이하
		System.out.println(tmap.ceilingKey(25));//이상
		System.out.println(tmap.ceilingEntry(24));//이상
