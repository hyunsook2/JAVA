...
public class LamdaRun {
	public static void main(String[] args) {
		...
		System.out.println(cal3.calc(3, 7));
		System.out.println(cal4.calc(9, 5));
		SimpleCal2 cal5 = (first, second)->Math.pow(first, second);
		System.out.println(cal5.calc(7, 3));
		System.out.println("========");
		//참조타입으로 변환(::)
		//메서드 참조
		//클래스 이름::메소드이름 or 참조변수명::메소드이름
