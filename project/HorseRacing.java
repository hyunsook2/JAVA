...
public class HorseRacing {
	...
	public static void main(String[] args) {
		...
		while (true) {
			...
			hList.add(new Horse("1",(win*100)/gameCount));
			hList.add(new Horse("2",(win*100)/gameCount));
			hList.add(new Horse("3",(win*100)/gameCount));
			hList.add(new Horse("4",(win*100)/gameCount));
			hList.add(new Horse("5",(win*100)/gameCount));
			hList.add(new Horse("6",(win*100)/gameCount));
			hList.add(new Horse("7",(win*100)/gameCount));
			hList.add(new Horse("8",(win*100)/gameCount));
			
		    System.out.println(gameCount + "번째 게임을 시작합니다.");
